...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "main", "www", "im", "4", "5", "6", "7", "8", "9" }
    local l = awful.layout.suit  -- Just to save some typing: use an alias.
    local layouts = { l.floating, l.tile, l.tile, l.tile, l.tile, l.tile, l.tile, l.tile, l.tile }
    ...
    table.insert(rightWidgets, s.mylayoutbox)
...
globalkeys = gears.table.join(
    ...
    -- brightness keys
    -- had to install xbacklight and create /etc/X11/xorg.conf as described here: https://askubuntu.com/questions/715306/xbacklight-no-outputs-have-backlight-property-no-sys-class-backlight-folder
...
clientkeys = gears.table.join(
   ...
   -- see https://awesomewm.org/doc/api/libraries/awful.placement.html
   awful.key({ modkey }, "Left",
      function (client)
	 -- TODO move to left screen if already on left border
   ...
   awful.key({ modkey }, "Up",
	 ...
	 local f = awful.placement.scale
	    + awful.placement.top
	    + (axis and awful.placement['maximize_'..axis] or nil)
	 local geo = f(client.focus, {honor_workarea=true, to_percent = 1})
      end,
      {description = "snap right", group = "client"}),
