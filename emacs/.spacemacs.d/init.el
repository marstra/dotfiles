...
before packages are loaded."
  ...
  (with-eval-after-load 'org-agenda
    ...
    (define-key org-agenda-mode-map (kbd "C-S-<up>") 'org-agenda-date-earlier-hours)

    (setq org-agenda-scheduled-leaders '("Sched" "S.%2dx"))
    (setq org-agenda-deadline-leaders '("Deadl" "In%2dd" "D.%2dx"))

    ;; show agenda repeater, see: https://whhone.com/posts/org-agenda-repeated-tasks/
